...
module.exports = function (program) {
  ...
  program
    .command('create-0.5 <projectTitle>')
    .description('Create a boilerplate Apostrophe 0.5 project')
    ...
    .action(function(projectTitle, options) {
      ...
      if (exec('git clone ' + config.APOSTROPHE_BOILERPLATE_OHFIVE + ' ' + projectTitle).code !== 0) {
        util.error('create');
        return false;
      }
