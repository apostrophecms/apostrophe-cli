...
module.exports = function (program) {
  ...
  program
    ...
    .action(function(pieceName, options) {
      ...
      util.nlog('createPiece', 'Adding '+ pieceName + ' folder to /lib/modules.');
      ...
      util.nlog('createPiece', 'Setting up index.js for '+ pieceName);
      fs.writeFileSync(path + '/index.js', pieceConfig);

      if(options.pages) {
        util.nlog('createPiece', 'Creating a '+ pieceName +'-pages folder with index.js and appropriate views');
      ...
      if(options.widgets) {
        util.nlog('createPiece', 'Creating a '+ pieceName +'-widget folder with index.js and appropriate views');
